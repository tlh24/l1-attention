...
attn_cpp = cpp.l1attn_cpp.L1AttnFunction.apply(*variables)

variables_cuda = [q.cuda(), k.cuda()]
attn_cuda = cuda.l1attn_cuda.L1AttnFunction.apply(*variables_cuda)
...
if gradcheck(cpp.l1attn_cpp.L1AttnFunction.apply, variables):
   print('Backward: Cpp grad Ok')

if gradcheck(cuda.l1attn_cuda.L1AttnFunction.apply, variables_cuda):
