...
if __name__ == '__main__':
	...
	while j < 200: 
		...
		model = Transformer(d_model=96, layers=cmd_args.layers, repeat=1, n_head=cmd_args.heads, init_zeros=False, gendata_dim=width)
		...
		if cmd_args.m: 
			...
			if cmd_args.a:
				optstr = 'adam'
			fd_vallog = open(f'vallog_x6_{optstr}_l{cmd_args.layers}_h{cmd_args.heads}_npos{npos}_width{width}.txt', 'a')
